...
if ("email" in possibleOrder) {
    var mustBeInternetOrder = possibleOrder;
}
// You can use the JavaScript "instanceof" operator if you
// have a class which conforms to the interface:
var TelephoneOrderClass = /** @class */ (function () {
    function TelephoneOrderClass() {
    }
    return TelephoneOrderClass;
}());
if (possibleOrder instanceof TelephoneOrderClass) {
    var mustBeTelephoneOrder = possibleOrder;
}
...
if (typeof possibleOrder === "undefined") {
    var definitelyNotAnOder = possibleOrder;
}
